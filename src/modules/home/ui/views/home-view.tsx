  ...
  const features = [
    {
      ...
      description:
        "Advanced AI that understands context and provides intelligent insights during meetings",
    },
    {
      icon: Video,
      title: "Seamless Video Integration",
      description:
        "Crystal-clear video calls with real-time AI analysis and support",
    },
    {
      icon: MessageSquare,
      title: "Intelligent Chat",
      description:
        "Get instant answers and explanations while staying focused on your meeting",
    },
    {
      icon: Users,
      title: "Collaborative Experience",
      description:
        "Enhanced team collaboration with AI-powered meeting facilitation",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover how Meet-AI revolutionizes your meeting experience with
      ...
      <section id="pricing" className="relative z-10 px-6 py-20" ref={pricingRef}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Start free and scale with your team. No hidden fees, cancel
              anytime.
            </p>
            ...
            <div className="group relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:scale-105 transition-all duration-500 hover:border-emerald-400/50">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <AnimatePresence>
                    {pricingInView && [
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Unlimited meetings" },
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Unlimited agents" },
                    ].map((feature, idx) => (
                      <motion.li
                        key={feature.text}
                ...
                <ul className="space-y-3">
                  <AnimatePresence>
                    {pricingInView && [
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Unlimited meetings" },
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Unlimited agents" },
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "2 months free" },
                    ].map((feature, idx) => (
                      <motion.li
                        key={feature.text}
                        initial={{ opacity: 0, x: 40 }}
                ...
                <ul className="space-y-3">
                  <AnimatePresence>
                    {pricingInView && [
                      ...
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Unlimited meetings" },
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Unlimited agents" },
                      { icon: <CheckCircle className="w-5 h-5 text-emerald-400 flex-shrink-0" />, text: "Dedicated Discord Support" },
                    ].map((feature, idx) => (
                      <motion.li
                        key={feature.text}
                        initial={{ opacity: 0, x: 40 }}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-emerald-800/30 to-green-800/30 rounded-3xl p-12 border border-emerald-400/30 backdrop-blur-lg hover:border-emerald-400/60 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-400/20">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Start your journey with AI-powered meetings today. No credit card
              required.
            </p>
      ...
      <footer className="relative z-10 px-6 py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-400">
            © 2025 Meet-AI. All rights reserved. Making meetings smarter, one
